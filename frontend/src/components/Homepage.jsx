    ...
    <div className="homepage">
      ...
      <section className="features" id="features">
        <div className="section-header">
          ...
          <p className="section-desc">
            Powerful tools designed to keep you informed and in control of your
            medications and well-being.
          </p>
        </div>
        <div className="features-grid">
          ...
          <div className="feature-card">
            ...
            <h3>Ask Questions</h3>
            <p>
              Chat naturally with AI about your treatments and receive clear,
              helpful answers in real time.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="ai-section" id="ai-insights">
        <div className="ai-content">
          ...
          <p className="section-desc">
            Powered by advanced AI from Anthropic Claude and OpenAI, MedSy
            translates complex medical data into insights you can actually
            understand.
          </p>
            ...
            <div className="ai-card-body">
              ...
              <div className="ai-msg ai-msg-bot">
                <div className="ai-typing">
                  Common side effects include nausea, dizziness, and stomach
                  pain. Serious but rare effects include allergic reactions and
                  GI bleeding. Always take with food to reduce stomach
                  irritation.
                </div>
              </div>
            </div>
